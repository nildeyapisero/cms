...
urlpatterns = [
    ...
    path('staff_view_leave/', StaffViews.staff_view_leave, name="staff_view_leave"),
    ...
    path('student_fee_structure/', StudentViews.student_fee_structure, name="student_fee_structure"),
]

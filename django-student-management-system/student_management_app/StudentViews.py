...
def student_home(request):
    ...
    #print("Course:",course_obj.course_name)
...
def student_feedback_save(request):
    if request.method != "POST":
        ...
        anonymous = request.POST.get('anonymous_check')
        student_obj = Students.objects.get(admin=request.user.id)

        try:
            add_feedback = FeedBackStudent(student_id=student_obj, feedback=feedback, feedback_reply="", anonymous = anonymous)
            add_feedback.save()
...
def student_fee_structure(request):
    return render(request, "student_template/student_fee_structure.html")